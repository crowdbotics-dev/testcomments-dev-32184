...
## Project Structure
    ...
    ├── testcomments_dev_32184  # Django project configurations
...
1. Clone this repo and `cd testcomments_dev_32184`
...
2. Clone this repo and `cd testcomments_dev_32184`
